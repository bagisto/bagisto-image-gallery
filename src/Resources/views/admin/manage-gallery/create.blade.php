<x-admin::layouts>
    <!-- Page Title -->
    <x-slot:title>
        @lang('image-gallery::app.admin.image-gallery.manage-gallery.create.page-title')
    </x-slot>
    ...
    @pushOnce('scripts')
        ...
        >
            <x-admin::form
                action="{{ route('admin.image-gallery.manage-gallery.store')}}"
                method="POST"
                ...
                <div class="grid gap-2.5">
                    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
                        ...
                        <div class="flex items-center gap-x-2.5">
                            ...
                            >
                                @lang('image-gallery::app.admin.image-gallery.manage-gallery.create.back-btn')
                            </a>

                            <button class="primary-button">
                                @lang('image-gallery::app.admin.image-gallery.manage-gallery.create.save-btn')
                            </button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="box-shadow rounded bg-white dark:bg-gray-900">
                            <div class="flex justify-between p-4">
                                <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                                    @lang('image-gallery::app.admin.image-gallery.manage-gallery.create.gallery') 
                                </p>
                            </div>
                            ...
                            <div class="flex flex-col p-4">
                                <div class="mb-2.5">
                                    <x-admin::form.control-group class="mb-2.5">
                                        <x-admin::form.control-group.label class="required">
                                            @lang('image-gallery::app.admin.image-gallery.manage-gallery.create.title')
                                        ...
                                        <x-admin::form.control-group.control
                                            ...
                                            :label="trans('image-gallery::app.admin.image-gallery.manage-gallery.create.title')"
                                            :placeholder="trans('image-gallery::app.admin.image-gallery.manage-gallery.create.title')"
                                        />
                                ...
                                <div class="mb-2.5">
                                    <x-admin::form.control-group class="mb-2.5">
                                        <x-admin::form.control-group.label class="required">
                                            @lang('image-gallery::app.admin.image-gallery.manage-gallery.create.gallery-code')
                                        </x-admin::form.control-group.label>
                                        ...
                                        <x-admin::form.control-group.control
                                            ...
                                            :value="old('gallery_code')"
                                            :label="trans('image-gallery::app.admin.image-gallery.manage-gallery.create.gallery-code')"
                                            :placeholder="trans('image-gallery::app.admin.image-gallery.manage-gallery.create.gallery-code')"
                                        />
                                ...
                                <div class="mb-2.5">
                                    <x-admin::form.control-group class="mb-2.5">
                                        <x-admin::form.control-group.label>
                                            @lang('image-gallery::app.admin.image-gallery.manage-gallery.create.status')
                                        </x-admin::form.control-group.label>
                                        ...
                                        <x-admin::form.control-group.control
                                            ...
                                            name="status"
                                            value="1"
                                            :label="trans('image-gallery::app.admin.image-gallery.manage-gallery.create.status')"
                                            :placeholder="trans('image-gallery::app.admin.image-gallery.manage-gallery.create.status')"
                                        />
