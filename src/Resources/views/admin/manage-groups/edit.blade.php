<x-admin::layouts>
    <!-- Page Title -->
    <x-slot:title>
        @lang('image-gallery::app.admin.image-gallery.manage-groups.edit.page-title')
    </x-slot>
    ...
    @pushOnce('scripts')
        ...
        >
            <x-admin::form
                action="{{ route('admin.image-gallery.manage-groups.update', $category->id) }}"
                method="PUT"
                ...
                <div class="grid gap-2.5">
                    <div class="flex items-center justify-between gap-4 max-sm:flex-wrap">
                        ...
                        <div class="flex items-center gap-x-2.5">
                            ...
                            >
                                @lang('image-gallery::app.admin.image-gallery.manage-groups.edit.back-btn')
                            </a>

                            <button class="primary-button">
                                @lang('image-gallery::app.admin.image-gallery.manage-groups.edit.save-btn')
                            </button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="box-shadow rounded bg-white dark:bg-gray-900">
                            <div class="flex justify-between p-4">
                                <p class="mb-4 text-base font-semibold text-gray-800 dark:text-white">
                                    @lang('image-gallery::app.admin.image-gallery.manage-groups.edit.group') 
                                </p>
                            </div>
                            ...
                            <div class="flex flex-col p-4">
                                <div class="mb-2.5">
                                    <x-admin::form.control-group class="mb-2.5">
                                        <x-admin::form.control-group.label class="required">
                                            @lang('image-gallery::app.admin.image-gallery.manage-groups.edit.group-code')
                                        ...
                                        <x-admin::form.control-group.control
                                            ...
                                            :value="old('group_code') ?? $category->group_code"
                                            :label="trans('image-gallery::app.admin.image-gallery.manage-groups.edit.group-code')"
                                            :placeholder="trans('image-gallery::app.admin.image-gallery.manage-groups.edit.group-code')"
                                        />
                                ...
                                <div class="mb-2.5">
                                    <x-admin::form.control-group class="mb-2.5">
                                        <x-admin::form.control-group.label>
                                            @lang('image-gallery::app.admin.image-gallery.manage-groups.edit.status')
                                        </x-admin::form.control-group.label>
                                        ...
                                        <x-admin::form.control-group.control
                                            ...
                                            :label="trans('image-gallery::app.admin.image-gallery.manage-groups.edit.status')"
                                            :placeholder="trans('image-gallery::app.admin.image-gallery.manage-groups.edit.status')"
                                        />
                        ...
                        >
                            ...
                            <div class="flex gap-2.5">
                                <input
                                    ...
                                    :value="record.id"
                                    :checked="isGallerySelected(record.id)"
                                    class="peer hidden"
                                    @click="getData($event)"
                                >
        ...
        <script type="module">
            app.component('v-gallery-table', {
                ...
                methods: {
                    getData(event) {
                        let isItemExist = this.$parent.selectedGalleryIds.find(id => id == event.target.value);

                        if (! isItemExist) {
                            this.$parent.selectedGalleryIds.push(event.target.value);
                        } else {
                            let index = this.$parent.selectedGalleryIds.indexOf(event.target.value);
                            
                            this.$parent.selectedGalleryIds.splice(index, 1);
                        }
                    },

                    isGallerySelected(id) {
                        if (this.$parent.groupGalleryIds) {
                            return this.$parent.groupGalleryIds.find(galleryId => galleryId == id);
                        }
                    }
                },
            });
        ...
        <script type="module">
            app.component('v-manage-groups', {
                ...
                mounted() {
                    if (this.groupData.gallery_ids) {
                        this.groupGalleryIds = this.groupData.gallery_ids.split(',');
                    }

                    for (let i = 0; i < this.groupGalleryIds.length; i++) {
                        this.selectedGalleryIds.push(this.groupGalleryIds[i]);
                    }
                }
            });
        </script>
